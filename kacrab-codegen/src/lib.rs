...
//!
//! The pipeline is split into six stages, each owning its own error type:
//!
...
//! 6. [`protocol_support`] — (optional) report per-API version support and cross-check it against
//!    the committed `client_api_info` table.
//!
