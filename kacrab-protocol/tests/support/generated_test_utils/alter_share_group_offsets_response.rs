...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = AlterShareGroupOffsetsResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "AlterShareGroupOffsetsResponse",
        java_class: "org.apache.kafka.common.message.AlterShareGroupOffsetsResponseData",
        version: 0i16,
