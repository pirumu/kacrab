...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = ListConfigResourcesRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "ListConfigResourcesRequest",
        java_class: "org.apache.kafka.common.message.ListConfigResourcesRequestData",
        version: 0i16,
