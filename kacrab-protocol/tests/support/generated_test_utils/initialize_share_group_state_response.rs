...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = InitializeShareGroupStateResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "InitializeShareGroupStateResponse",
        java_class: "org.apache.kafka.common.message.InitializeShareGroupStateResponseData",
        version: 0i16,
