...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = AlterPartitionReassignmentsResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "AlterPartitionReassignmentsResponse",
        java_class: "org.apache.kafka.common.message.AlterPartitionReassignmentsResponseData",
        version: 0i16,
