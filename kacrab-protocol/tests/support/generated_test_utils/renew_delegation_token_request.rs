...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = RenewDelegationTokenRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "RenewDelegationTokenRequest",
        java_class: "org.apache.kafka.common.message.RenewDelegationTokenRequestData",
        version: 1i16,
