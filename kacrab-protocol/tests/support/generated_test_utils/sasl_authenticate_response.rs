...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = SaslAuthenticateResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "SaslAuthenticateResponse",
        java_class: "org.apache.kafka.common.message.SaslAuthenticateResponseData",
        version: 0i16,
