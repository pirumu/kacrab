...
impl TestInstance for AlterPartitionReassignmentsRequestData {
    fn test_populated(version: i16) -> Self {
        Self {
            ...
            topics: vec![<ReassignableTopic as TestInstance>::test_populated(version)],
    ...
    fn test_multi_element_collections(version: i16) -> Self {
        Self {
            ...
            allow_replication_factor_change: if version >= 1 { false } else { true },
            topics: vec![
                <ReassignableTopic as TestInstance>::test_populated(version),
                <ReassignableTopic as TestInstance>::test_multi_element_collections(version),
            ],
            _unknown_tagged_fields: Vec::new(),
        }
    }
    fn test_numeric_boundaries(version: i16) -> Self {
        Self {
            timeout_ms: i32::MIN,
            allow_replication_factor_change: true,
            topics: vec![<ReassignableTopic as TestInstance>::test_numeric_boundaries(version)],
            _unknown_tagged_fields: Vec::new(),
        }
    }
...
impl TestInstance for ReassignableTopic {
    ...
    fn test_null_optionals(version: i16) -> Self {
        ...
        Self {
            ...
            partitions: vec![<ReassignablePartition as TestInstance>::test_null_optionals(version)],
            _unknown_tagged_fields: Vec::new(),
        }
    }
    ...
    fn test_multi_element_collections(version: i16) -> Self {
        Self {
            ...
            partitions: vec![
                <ReassignablePartition as TestInstance>::test_populated(version),
                <ReassignablePartition as TestInstance>::test_multi_element_collections(version),
            ],
            _unknown_tagged_fields: Vec::new(),
        }
    }
    fn test_numeric_boundaries(version: i16) -> Self {
        Self {
            ...
            partitions: vec![
                <ReassignablePartition as TestInstance>::test_numeric_boundaries(version),
            ],
            _unknown_tagged_fields: Vec::new(),
        }
    }
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionReassignmentsRequestData as TestInstance>::test_populated(version);
...
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message =
        <AlterPartitionReassignmentsRequestData as TestInstance>::test_null_optionals(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message =
        <AlterPartitionReassignmentsRequestData as TestInstance>::test_empty_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message =
        <AlterPartitionReassignmentsRequestData as TestInstance>::test_numeric_boundaries(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message =
        <AlterPartitionReassignmentsRequestData as TestInstance>::test_tagged_fields(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
