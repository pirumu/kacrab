...
use kacrab_protocol::{generated::alter_partition_response::*, *};

use crate::TestInstance;

impl TestInstance for AlterPartitionResponseData {
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionResponseData as TestInstance>::test_populated(version);
...
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionResponseData as TestInstance>::test_null_optionals(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionResponseData as TestInstance>::test_empty_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_multi_element_collections(version: i16) -> crate::MatrixResult<String> {
    let message =
        <AlterPartitionResponseData as TestInstance>::test_multi_element_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionResponseData as TestInstance>::test_numeric_boundaries(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterPartitionResponseData as TestInstance>::test_tagged_fields(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = AlterPartitionResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "AlterPartitionResponse",
        java_class: "org.apache.kafka.common.message.AlterPartitionResponseData",
        version: 2i16,
