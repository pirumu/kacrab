...
impl TestInstance for PartitionData {
    fn test_populated(version: i16) -> Self {
        Self {
            ...
            preferred_successors: if version == 0 {
                vec![12345_i32]
            } else {
                Vec::new()
            },
            preferred_candidates: if version >= 1 {
                vec![<ReplicaInfo as TestInstance>::test_populated(version)]
            } else {
                Vec::new()
            },
            _unknown_tagged_fields: vec![RawTaggedField {
    ...
    fn test_null_optionals(version: i16) -> Self {
        ...
        Self {
            ...
            preferred_candidates: if version >= 1 {
                vec![<ReplicaInfo as TestInstance>::test_null_optionals(version)]
            } else {
                Vec::new()
            },
            _unknown_tagged_fields: Vec::new(),
    ...
    fn test_multi_element_collections(version: i16) -> Self {
        Self {
            ...
            preferred_candidates: if version >= 1 {
                vec![
                    <ReplicaInfo as TestInstance>::test_populated(version),
                    <ReplicaInfo as TestInstance>::test_multi_element_collections(version),
                ]
            } else {
                Vec::new()
            },
    ...
    fn test_numeric_boundaries(version: i16) -> Self {
        Self {
            ...
            preferred_candidates: if version >= 1 {
                vec![<ReplicaInfo as TestInstance>::test_numeric_boundaries(
                    version,
                )]
            } else {
                Vec::new()
    ...
    fn test_tagged_fields(version: i16) -> Self {
        Self {
            ...
            preferred_candidates: if version >= 1 {
                vec![<ReplicaInfo as TestInstance>::test_tagged_fields(version)]
            } else {
                Vec::new()
            },
            _unknown_tagged_fields: vec![RawTaggedField {
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <EndQuorumEpochRequestData as TestInstance>::test_populated(version);
...
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message = <EndQuorumEpochRequestData as TestInstance>::test_null_optionals(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <EndQuorumEpochRequestData as TestInstance>::test_empty_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_multi_element_collections(version: i16) -> crate::MatrixResult<String> {
    let message =
        <EndQuorumEpochRequestData as TestInstance>::test_multi_element_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message = <EndQuorumEpochRequestData as TestInstance>::test_numeric_boundaries(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message = <EndQuorumEpochRequestData as TestInstance>::test_tagged_fields(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
