...
use kacrab_protocol::{generated::alter_configs_request::*, *};

use crate::TestInstance;

impl TestInstance for AlterConfigsRequestData {
    ...
    fn test_multi_element_collections() -> Self {
        Self {
            resources: vec![
                <AlterConfigsResource as TestInstance>::test_populated(),
                <AlterConfigsResource as TestInstance>::test_multi_element_collections(),
            ],
            validate_only: false,
            _unknown_tagged_fields: Vec::new(),
        }
    ...
    fn test_numeric_boundaries() -> Self {
        Self {
            resources: vec![<AlterConfigsResource as TestInstance>::test_numeric_boundaries()],
            validate_only: true,
            _unknown_tagged_fields: Vec::new(),
        }
    }
...
impl TestInstance for AlterConfigsResource {
    fn test_populated() -> Self {
        Self {
            ...
            configs: vec![<AlterableConfig as TestInstance>::test_populated()],
            _unknown_tagged_fields: vec![RawTaggedField {
                tag: 254,
                data: Bytes::from_static(&[0xab]),
            }],
    ...
    fn test_multi_element_collections() -> Self {
        Self {
            ...
            configs: vec![
                <AlterableConfig as TestInstance>::test_populated(),
                <AlterableConfig as TestInstance>::test_multi_element_collections(),
            ],
            _unknown_tagged_fields: Vec::new(),
        }
    }
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_populated();
...
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_null_optionals();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_empty_collections();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_multi_element_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_multi_element_collections();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_numeric_boundaries();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message = <AlterConfigsRequestData as TestInstance>::test_tagged_fields();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = AlterConfigsRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "AlterConfigsRequest",
        java_class: "org.apache.kafka.common.message.AlterConfigsRequestData",
        version: 0i16,
