...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = AlterReplicaLogDirsRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "AlterReplicaLogDirsRequest",
        java_class: "org.apache.kafka.common.message.AlterReplicaLogDirsRequestData",
        version: 1i16,
