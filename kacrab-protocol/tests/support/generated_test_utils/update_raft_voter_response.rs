...
impl TestInstance for UpdateRaftVoterResponseData {
    fn test_populated(version: i16) -> Self {
        Self {
            ...
            error_code: 42_i16,
            current_leader: <CurrentLeader as TestInstance>::test_populated(version),
    ...
    fn test_empty_collections(version: i16) -> Self {
        Self {
            throttle_time_ms: 0_i32,
            error_code: 0_i16,
            current_leader: <CurrentLeader as TestInstance>::test_null_optionals(version),
            _unknown_tagged_fields: Vec::new(),
        }
    }
    ...
    fn test_numeric_boundaries(version: i16) -> Self {
        Self {
            ...
            error_code: i16::MIN,
            current_leader: <CurrentLeader as TestInstance>::test_numeric_boundaries(version),
            _unknown_tagged_fields: Vec::new(),
        }
    }
    fn test_tagged_fields(version: i16) -> Self {
        Self {
            throttle_time_ms: 12345_i32,
            error_code: 42_i16,
            current_leader: <CurrentLeader as TestInstance>::test_tagged_fields(version),
            _unknown_tagged_fields: vec![RawTaggedField {
                tag: 254,
                data: Bytes::from_static(&[0xab]),
            }],
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <UpdateRaftVoterResponseData as TestInstance>::test_populated(version);
...
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message = <UpdateRaftVoterResponseData as TestInstance>::test_null_optionals(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <UpdateRaftVoterResponseData as TestInstance>::test_empty_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_multi_element_collections(version: i16) -> crate::MatrixResult<String> {
    let message =
        <UpdateRaftVoterResponseData as TestInstance>::test_multi_element_collections(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message = <UpdateRaftVoterResponseData as TestInstance>::test_numeric_boundaries(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
...
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message = <UpdateRaftVoterResponseData as TestInstance>::test_tagged_fields(version);
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
