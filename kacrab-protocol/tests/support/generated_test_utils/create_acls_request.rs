...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = CreateAclsRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "CreateAclsRequest",
        java_class: "org.apache.kafka.common.message.CreateAclsRequestData",
        version: 1i16,
