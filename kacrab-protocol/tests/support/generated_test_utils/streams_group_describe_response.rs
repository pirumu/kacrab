...
impl TestInstance for Topology {
    fn test_populated() -> Self {
        Self {
            epoch: 12345_i32,
            subtopologies: Some(vec![<Subtopology as TestInstance>::test_populated()]),
            _unknown_tagged_fields: vec![RawTaggedField {
                tag: 254,
                data: Bytes::from_static(&[0xab]),
            }],
    ...
    fn test_null_optionals() -> Self {
        drop(Self::default());
        drop(<Subtopology as TestInstance>::test_null_optionals());
        Self {
            epoch: 0_i32,
            subtopologies: None,
            _unknown_tagged_fields: Vec::new(),
    ...
    fn test_numeric_boundaries() -> Self {
        Self {
            epoch: i32::MIN,
            subtopologies: Some(vec![
                <Subtopology as TestInstance>::test_numeric_boundaries(),
            ]),
            _unknown_tagged_fields: Vec::new(),
        }
    }
...
impl TestInstance for Member {
    fn test_populated() -> Self {
        Self {
            ...
            client_tags: vec![<KeyValue as TestInstance>::test_populated()],
            task_offsets: vec![<TaskOffset as TestInstance>::test_populated()],
            task_end_offsets: vec![<TaskOffset as TestInstance>::test_populated()],
    ...
    fn test_null_optionals() -> Self {
        ...
        Self {
            ...
            user_endpoint: None,
            client_tags: vec![<KeyValue as TestInstance>::test_null_optionals()],
            task_offsets: vec![<TaskOffset as TestInstance>::test_null_optionals()],
            task_end_offsets: vec![<TaskOffset as TestInstance>::test_null_optionals()],
    ...
    fn test_numeric_boundaries() -> Self {
        Self {
            ...
            client_tags: vec![<KeyValue as TestInstance>::test_numeric_boundaries()],
    ...
    fn test_tagged_fields() -> Self {
        Self {
            ...
            client_tags: vec![<KeyValue as TestInstance>::test_tagged_fields()],
            task_offsets: vec![<TaskOffset as TestInstance>::test_tagged_fields()],
            task_end_offsets: vec![<TaskOffset as TestInstance>::test_tagged_fields()],
...
impl TestInstance for Assignment {
    fn test_populated() -> Self {
        Self {
            active_tasks: vec![<TaskIds as TestInstance>::test_populated()],
            standby_tasks: vec![<TaskIds as TestInstance>::test_populated()],
            warmup_tasks: vec![<TaskIds as TestInstance>::test_populated()],
            _unknown_tagged_fields: vec![RawTaggedField {
                tag: 254,
                data: Bytes::from_static(&[0xab]),
            }],
    ...
    fn test_null_optionals() -> Self {
        drop(Self::default());
        Self {
            active_tasks: vec![<TaskIds as TestInstance>::test_null_optionals()],
            standby_tasks: vec![<TaskIds as TestInstance>::test_null_optionals()],
            warmup_tasks: vec![<TaskIds as TestInstance>::test_null_optionals()],
            _unknown_tagged_fields: Vec::new(),
        }
    }
    fn test_empty_collections() -> Self {
    ...
    fn test_numeric_boundaries() -> Self {
        Self {
            active_tasks: vec![<TaskIds as TestInstance>::test_numeric_boundaries()],
            standby_tasks: vec![<TaskIds as TestInstance>::test_numeric_boundaries()],
            warmup_tasks: vec![<TaskIds as TestInstance>::test_numeric_boundaries()],
            _unknown_tagged_fields: Vec::new(),
        }
    }
    fn test_tagged_fields() -> Self {
        Self {
            active_tasks: vec![<TaskIds as TestInstance>::test_tagged_fields()],
            standby_tasks: vec![<TaskIds as TestInstance>::test_tagged_fields()],
            warmup_tasks: vec![<TaskIds as TestInstance>::test_tagged_fields()],
            _unknown_tagged_fields: vec![RawTaggedField {
                tag: 254,
                data: Bytes::from_static(&[0xab]),
            }],
...
fn encode_populated(version: i16) -> crate::MatrixResult<String> {
    let message = <StreamsGroupDescribeResponseData as TestInstance>::test_populated();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
fn encode_null_optionals(version: i16) -> crate::MatrixResult<String> {
    let message = <StreamsGroupDescribeResponseData as TestInstance>::test_null_optionals();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
fn encode_empty_collections(version: i16) -> crate::MatrixResult<String> {
    let message = <StreamsGroupDescribeResponseData as TestInstance>::test_empty_collections();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
fn encode_multi_element_collections(version: i16) -> crate::MatrixResult<String> {
    let message =
        <StreamsGroupDescribeResponseData as TestInstance>::test_multi_element_collections();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
fn encode_numeric_boundaries(version: i16) -> crate::MatrixResult<String> {
    let message = <StreamsGroupDescribeResponseData as TestInstance>::test_numeric_boundaries();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
fn encode_tagged_fields(version: i16) -> crate::MatrixResult<String> {
    let message = <StreamsGroupDescribeResponseData as TestInstance>::test_tagged_fields();
    let mut out = BytesMut::new();
    message.write(&mut out, version)?;
    Ok(crate::hex(out.as_ref())?)
}
