...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = CreateDelegationTokenResponseData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "CreateDelegationTokenResponse",
        java_class: "org.apache.kafka.common.message.CreateDelegationTokenResponseData",
        version: 1i16,
