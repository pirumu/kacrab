...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = ApiVersionsRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "ApiVersionsRequest",
        java_class: "org.apache.kafka.common.message.ApiVersionsRequestData",
        version: 0i16,
