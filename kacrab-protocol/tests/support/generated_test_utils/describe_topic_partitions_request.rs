...
fn reencode(version: i16, hex_input: &str) -> crate::MatrixResult<String> {
    ...
    let message = DescribeTopicPartitionsRequestData::read(&mut input, version)?;
...
const MATRIX_CASES: &[crate::MatrixCase] = &[
    crate::MatrixCase {
        schema_name: "DescribeTopicPartitionsRequest",
        java_class: "org.apache.kafka.common.message.DescribeTopicPartitionsRequestData",
        version: 0i16,
