//! Generated from ConsumerGroupHeartbeatResponse.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct ConsumerGroupHeartbeatResponseData {
    ...
    /// The member id is generated by the consumer starting from version 1, while in version 0, it
    /// can be provided by users or generated by the group coordinator.
...
impl Default for ConsumerGroupHeartbeatResponseData {
    fn default() -> Self {
        Self {
...
impl ConsumerGroupHeartbeatResponseData {
