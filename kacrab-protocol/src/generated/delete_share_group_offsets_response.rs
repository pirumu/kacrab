//! Generated from DeleteShareGroupOffsetsResponse.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
impl Default for DeleteShareGroupOffsetsResponseData {
    fn default() -> Self {
        Self {
...
impl DeleteShareGroupOffsetsResponseData {
    pub fn read(buf: &mut Bytes, version: i16) -> Result<Self> {
        ...
        responses = {
            ...
            for _ in 0..len {
                arr.push(DeleteShareGroupOffsetsResponseTopic::read(buf, version)?);
            }
            arr
        };
