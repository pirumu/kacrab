//! Generated from AddRaftVoterResponse.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct AddRaftVoterResponseData {
...
impl Default for AddRaftVoterResponseData {
    fn default() -> Self {
        Self {
