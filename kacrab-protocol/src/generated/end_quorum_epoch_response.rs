//! Generated from EndQuorumEpochResponse.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct EndQuorumEpochResponseData {
...
impl Default for EndQuorumEpochResponseData {
    fn default() -> Self {
        Self {
            error_code: 0_i16,
            topics: Vec::new(),
...
impl EndQuorumEpochResponseData {
