//! Generated from ConsumerGroupDescribeRequest.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct ConsumerGroupDescribeRequestData {
...
impl Default for ConsumerGroupDescribeRequestData {
    fn default() -> Self {
        Self {
            group_ids: Vec::new(),
...
impl ConsumerGroupDescribeRequestData {
