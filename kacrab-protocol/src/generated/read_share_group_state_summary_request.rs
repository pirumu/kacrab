//! Generated from ReadShareGroupStateSummaryRequest.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct ReadShareGroupStateSummaryRequestData {
...
impl Default for ReadShareGroupStateSummaryRequestData {
    fn default() -> Self {
        Self {
...
impl ReadShareGroupStateSummaryRequestData {
    ...
    pub fn read(buf: &mut Bytes, version: i16) -> Result<Self> {
        ...
        topics = {
            ...
            for _ in 0..len {
                arr.push(ReadStateSummaryData::read(buf, version)?);
            }
            arr
        };
