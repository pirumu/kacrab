//! Generated from InitializeShareGroupStateResponse.json - DO NOT EDIT
#![allow(
    missing_docs,
    clippy::all,
    clippy::pedantic,
...
pub struct InitializeShareGroupStateResponseData {
    /// The initialization results.
    pub results: Vec<InitializeStateResult>,
    pub _unknown_tagged_fields: Vec<RawTaggedField>,
}
impl Default for InitializeShareGroupStateResponseData {
    fn default() -> Self {
        Self {
            results: Vec::new(),
...
impl InitializeShareGroupStateResponseData {
    pub fn read(buf: &mut Bytes, version: i16) -> Result<Self> {
        ...
        results = {
            ...
            for _ in 0..len {
                arr.push(InitializeStateResult::read(buf, version)?);
            }
            arr
        };
