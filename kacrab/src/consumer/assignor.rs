...
//!
//! Phase 2b ships eager assignment with the `range` assignor — the first of
//! Kafka's default `[range, cooperative-sticky]` pair. Cooperative (incremental)
//! rebalancing is a later refinement. Subscription/assignment blobs are the
...
/// The one assignor Phase 2b advertises.
